...
const BocLr = () => {
  ...
  const generatePDF = (count) => {
    ...
    pdf.addImage(Logo, "PNG", 8, 5, 100, 27);
    pdf.setFontSize(18);
    ...
    pdf.text(106, 56.5,`LR No: BOC${randomnum}`);
...
pdf.rect(12, 157, 100, 50)
    ...
    const pdfName = `Boc_LR_${sanitizedName}.pdf`;
