...
let count = day + 166;
  ...
  const generatePDF = (count) => {
    ...
    pdf.text(`FRIGHT BILL: ${count}`, 108, 52.5, { align: "left" });
    ...
    let subTotal = (parseInt(formData.transportCharges) || 0) + (parseInt(strCharges) || 0) + (parseInt(formData.docCharges) || 0) + (parseInt(formData.insurance) || 0)
    pdf.setFontSize(14);
